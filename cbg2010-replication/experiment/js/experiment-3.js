// replication of Cimpian, Brandone & Gelman (2010); Exp 4
// with one context from Exp 1
...
//  exp.stimtype = _.shuffle(["bare","danger","irrelevant"]);
  exp.stimtype = ["danger","distinct","irrelevant"]; //because there is list1, list2, list3
