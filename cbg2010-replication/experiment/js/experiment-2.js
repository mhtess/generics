  ...
  slides.implied_prevalence = slide({
    ...
    present_handle : function(stim_num) {
      ...
      if (exp.condition=='catprop'){
        var evidence_prompt = "Your team just identified a new animal on the island, which they're calling " + this.stim.category +".\nA different team has just reported finding an animal with "+ this.stim.color + " " + this.stim.part + " on the island.\n"
        $(".evidence").html(evidence_prompt);
        var query_prompt = "In your expert opinion, what percentage of "  + this.stim.category + " do you think have " + this.stim.color + " " + this.stim.part + "?\n";
      } else{
        var query_prompt = "What percentage of "  + this.stim.category + " do you think have " + this.stim.color + " " + this.stim.part + "?\n";
      }
