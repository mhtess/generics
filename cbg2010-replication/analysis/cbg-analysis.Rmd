...
f0<-read.csv(paste(tfbt.dir,'post_exp5bare_generic_truth_conditions_mh1000_3_alpha3.csv',sep=''),header=F,col.names='value')
f0$quantifier<-'generic'
f0$context<-'bare'
# ggplot(data=f0,aes(x=value))+geom_histogram()+
#   scale_x_continuous(limits=c(0,100),breaks=c(10,30,50,70,90))
f1<-read.csv(paste(tfbt.dir,'post_exp5nondistinctive_generic_truth_conditions_mh1000_3_alpha3.csv',sep=''),header=F,col.names='value')
f1$quantifier<-'generic'
f1$context<-'nondistinctive-control'
f2<-read.csv(paste(tfbt.dir,'post_exp5dangerdistinct_generic_truth_conditions_mh1000_3_alpha3.csv',sep=''),header=F,col.names='value')
f2$quantifier<-'generic'
...
g0<-read.csv(paste(tfbt.dir,'post_exp4bare_generic_truth_conditions_mh1000_3_alpha3.csv',sep=''),header=F,col.names='value')
g0$quantifier<-'generic'
g0$context<-'bare'
g1<-read.csv(paste(tfbt.dir,'post_exp4irrelevant_generic_truth_conditions_mh1000_3_alpha3.csv',sep=''),header=F,col.names='value')
g1$quantifier<-'generic'
g1$context<-'irrelevant'
g2<-read.csv(paste(tfbt.dir,'post_exp4distinct_generic_truth_conditions_mh1000_3_alpha3.csv',sep=''),header=F,col.names='value')
g2$quantifier<-'generic'
g2$context<-'distinct'

exp4.tfbt<-rbind(g0,g1,g2)

exp4.tfbt$quantifier<- factor(exp4.tfbt$quantifier)
exp4.tfbt$context<-factor(exp4.tfbt$context)
