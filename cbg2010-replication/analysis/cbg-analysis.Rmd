...
p3<-read.csv('post_bare_most_implied_prevalence_mh1000_100L1norm_f3_alpha2.csv',header=F)
p10<-read.csv('post_bare_most_implied_prevalence_mh1000_100L1norm_f10_alpha2.csv',header=F)                    
p100<-read.csv('post_bare_most_implied_prevalence_mh1000_100L1norm_f100_alpha2.csv',header=F)

qplot(data=p3,x=V1,geom='histogram')
qplot(data=p10,x=V1,geom='histogram')
qplot(data=p100,x=V1,geom='histogram')
