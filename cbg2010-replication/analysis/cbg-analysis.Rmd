...
m<-merge(d.sum,tc.bs, by=c("context", "prevalence"))
with(m, cor(pr.true.x,pr.true.y))
...
d<-read.csv(paste('listen_betaHyper_discreteHyper_exp9all_generic_truth_conditions_mh1000_100_alpha3.csv',sep=''),header=F)
