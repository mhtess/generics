...
dm.bs<-filter(dm.bs, context%in%c("accidental","plain"))
...
ggplot(dm.bs, aes(x=type,y=imp_subj,fill=type,alpha=task, group=task))+
  geom_bar(stat='identity',fill='black',
           position=position_dodge(0.5), width=0.5,color='black')+
  geom_errorbar(aes(ymin=YMin,ymax=YMax),
                width=0.2,
                size=1,
                color='black',
...
#m.tidy$type <- factor(m.tidy$type, labels=c("plain","danger","distinct"))
ggplot(data=m.tidy,aes(x=prev,y=expected.value,color=type,group=type))+
  geom_point(size=2.5, position=position_dodge(6))+
  geom_line(size=1,position=position_dodge(6), linetype=3, alpha=0.5)+
...
ggplot(sum.tidy, aes(x=type,y=expected.value,fill=type,alpha=task, group=task))+
  geom_bar(stat='identity',fill='black',
           position=position_dodge(0.5), width=0.5,color='black')+
  geom_errorbar(aes(ymin=CIlow,ymax=CIhigh),
                width=0.2,
