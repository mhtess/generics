...
Generic meanings are hard to pin down.  Consider President Obama's remark during the State of the Union Address. The second sentence is a generic statement about \emph{Members of both parties}. It invites the question: ``Exactly how many members told you this?'' President Obama's statement is conceivably true  for a range of possible values. At the same time, he is not a man to waste words, and so why does he go through the trouble of saying such a statement? Using our knowledge of the world---and the state of the Union---we can infer that probably not that many members have and probably that he would like us to think that many members have.
