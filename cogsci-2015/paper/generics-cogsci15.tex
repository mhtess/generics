...
%
The medians of these three distributions were all significantly different from one another, evidenced by pair-wise Mann-Whitney U tests ($DD$ vs. $P$: $W=417452$; $DD$ vs. $NI$: $W=376180.5$; $NI$ vs. $P$: $W=548994.5$; all $p < 0.00001$; $\mu_{DD} = 18.1\%$, $\mu_{NI} = 25.7\%$, $\mu_{P} = 20.8\%$). 
%
