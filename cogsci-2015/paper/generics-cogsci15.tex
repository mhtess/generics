...
\begin{align}
\theta \thicksim U(0,1) \\
\phi \thicksim U(0,1) %\mid  t \in \{exp1a, exp1b\}
\end{align}
...
The inflexibility of the model can also be seen in the posterior predictive distribution of responses (Figure \ref{blah}, left). 
