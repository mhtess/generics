...
%
%todo
%1. figure out which plots to use for fixed-threshold and lvRSA  (both TFBT stuff and posterior predictives)
%2. what kind of evidence do we want to use at the end to relate inferred priors to elicited? 
...
\section{Bayesian data analysis of truth conditions}
...
We can then ask, how must the threshold vary across tasks and conditions to account for the data?
