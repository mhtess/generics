%todo:
% - write abstract
% - address and then remove all of Noah's comments in red.
% - finish expt 2 results: update correlation and report split-half correlation. show that the means differ across contexts.spearman prophecy for prior correlations
% - replace table 1 with a figure of posteriors?
% - posterior predictives for prevalence prior

% - plots of schematic prior and simulation results. accidental and mosquitos prior results for discussion. make a little figure showing prior and truth-judgement predictions for each?
