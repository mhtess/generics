...
s <- read.table('../turk/exp9/cbgR-exp9-subject_information.tsv',header=T)
...
s<-data.frame(eggs = c(rbeta(3000,50,50),rbeta(7000,100,10000)),
...
ggplot(tc.tidy, aes(x=prevlev,y=value,
                  fill=key, group=key))+
  geom_bar(position=position_dodge(),stat='identity',color='black', alpha=0.8)+
...
d<-read.csv('bootstrap//lvRSAemprior_ACCIDENTAL_mh1000_10.csv',header=F)
