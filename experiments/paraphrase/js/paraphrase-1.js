...
function make_slides(f) {
  ...
  //    this.prevalence = exp.prevalence_levels[this.stim.list].splice(0,1)[0] // grab prevalence level for this list
      ...
      var query_prompt = "Do you agree with the following summaries of this information?"
      ...
      var isare = ''
      this.stim.part == 'fur' ? isare = 'is' : isare = 'are';
