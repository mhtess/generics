...
rs.asymmetry<-lmer(data=d.asymmetry, 
                   prev~ type*src + (1 | workerid))

summary(rs.asymmetry)


rs1<-lmer(data=d.implied, response~type + (1 | workerid))
summary(rs1)
...
ggsave(file='~/Documents/research/generics/manuscript/figures/cogsci/prior2_gamma-between-posterior-50k.pdf', width=12, height = 3)
...
ggsave(file='~/Documents/research/generics/manuscript/figures/cogsci/prior2_delta-posterior-50k.pdf', width=12, height = 3)
...
ggsave(c,file='~/Documents/research/generics/manuscript/figures/cogsci/prior2_prevalenceprior-50k.pdf',width=12, height= 4)
```
...
ggsave(file='~/Documents/research/generics/manuscript/figures/cogsci/asym-data-model-4opts-75k.pdf', width=11, height = 6)
