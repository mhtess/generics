...
write.csv(d,file='~/Documents/research/generics/models/data/asymmetry-prior-4splitAccidentalFBT-trials.csv', row.names=F)
...
d<-read.csv("~/Documents/research/generics/models/results/generics-priorUncertainty-impliedOpt-hashmh1000_asym2-prior4-incrmh10k.csv")
