...
samples = 40000
paramsetups = "4opts-phi"

d<-read.csv(paste("~/Documents/research/generics/models/results/generics-priorUncertainty-",paramsetups,"-hashmh",samples,"_asym2-prior4-incrmh10k.csv",sep=''))
