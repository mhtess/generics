...
For properties that are extremely rare (e.g. carrying malaria), a lower overall prevalence might result in an acceptable generic utterance. 
...
\centering
    ...
    Generic statements are accepted for a range of prevalences, resulting in an intermediate average prevalence (dotted line) for ``truth conditions''. 
    Upon hearing a generic statement about biological properties, participants infer that a high proportion of the category has the property (solid line: red, blue and green). 
