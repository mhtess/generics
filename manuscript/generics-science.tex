...
The distribution of ``has manes'' has the feature of being relatively rare across categories (large density at 0), and within a category has an expected value of around 50\%, though there is considerable uncertainty in judgments as to what percentage of an arbitrary animal kind to expect to have manes (Figure \ref{fig:priors1a} bottom left; within-category prevalence given by blue dotted line). 
...
in addition to the prevalence estimates of category--property pairs later in the generic language model to predict the acceptability of generics of natural cases.
