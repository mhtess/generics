...
Prevalence priors have two important components: one corresponds to the categories for which the property is absent and manifests as a density at 0\% prevalence; the other represents the categories for which the property is present and is the remaining density. 
...
The mean of the density not at 0\% is the measure of \emph{within-category prevalence} (e.g. for the categories for which \emph{lays eggs} is present, about 67\% of the category is believed to \emph{lay eggs}).
Figure \ref{fig:priors1a} shows the between-category and within-category prevalence for all 21 different properties as well as the full distribution on prevalence for 4 properties of interest.
