...
In this paper we offer a mathematical model of generic language in terms of pragmatic inference of the statistical strength required to assert a generic.  
