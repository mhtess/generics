...
The prior distribution over prevalence for a property can be summarized by the property's \emph{distinctiveness} (i.e., how many different animal kinds have the property) and the \emph{mean conditional prevalence} (e.g. average prevalence among the kinds for which the property is present).
...
The listener and speaker pair of models predicts human endorsements and interpretations of novel generic utterances well ($r^2(10) = 0.921$)\footnote{We performed a by-item analysis for the implied prevalence data and found a similar strong fit to the data ($r^2(40) = 0.89$; see Supplement Section D5)}. 
