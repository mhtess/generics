...
A hint lies in the vagueness of generics: With an uncertain meaning and the pressure to be informative, interpretation is heavily driven by \emph{a priori} beliefs about property. 
...
\citeA{Cimpian2010} reported a surprising d\'{e}colage between the interpretations of novel generics and the average prevalence required to assent to the exact same utterance\footnote{This asymmetry did not exist for the quantifier ``Most'', thought to be the most similar quantifier to the generic.}.
To explore this, we recruited participants ($n=40$) to help determine the average prevalence at which a speaker would assent to the generic. 
...
We computed the average prevalence that led to an assenting judgment, for each property type and each participant, following \citeA{Cimpian2010}.
...
Interpretations of generic utterances are stronger than their average truth conditions for biological properties but not for accidental properties (Figure \ref{fig:exp2b}). 
