...
%\ndg{a new asbtract:}
Generalizations about categories are central to human understanding, and generic language (e.g.~\emph{Dogs bark.}) provides a simple and ubiquitous \mht{(comprehensive?)} way to communicate these generalizations. 
