...
samples = 10000
prefix<-'generics-naturalPriors-singleFactor-postPred-n57-continuous-incrMH10000_burn5000' 
m1<-read.csv(paste(m.path, prefix, 'c.csv', sep=''))
...
# ggplot(m.pp, aes(x=to.n(Bin), y = MAP))+
...
ggplot(prior.md, aes(x=MAP, y = norm_count, color=factor(Bin)))+
  geom_point()+
