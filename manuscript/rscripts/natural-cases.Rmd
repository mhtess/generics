...
```{r}
s1<-head(read.csv('~/Documents/research/generics/experiments/turk/real-kinds-prior-2/n30/real-kinds-2_invoice_first25.csv'),-3)
s2<-head(read.csv('~/Documents/research/generics/experiments/turk/real-kinds-prior-2/real-kinds-2pilot5/real-kinds-2_invoice.csv'),-3)
s3<-head(read.csv('~/Documents/research/generics/experiments/turk/real-kinds-prior-2/real-kinds-2_invoice.csv'),-3)

allsubjects<- bind_rows(s1,s2,s3)

unique(allsubjects$workerid)

duplicate.subjects<- c("A3P74FP62XNVYI","A2G7N0X0PNX0EE","A2DXEPC4QFV4R1")
duplicte.workerids<-c(1:30)[s3$workerid%in%duplicate.subjects]
```
...
dwithDups<-read.csv(file = '../experiments/turk/real-kinds-prior-2/real-kinds-2-trials.csv')

# remove duplicate subjects
d<-dwithDups[!(dwithDups$workerid%in%duplicte.workerids),]

d0<-read.csv(file='../experiments/turk/real-kinds-prior-2/real-kinds-2pilot5/real-kinds-2-trials.csv')
d1<-read.csv(file='../experiments/turk/real-kinds-prior-2/n30/real-kinds-2-trials.csv')


d0$workerid = max(d$workerid) + d0$workerid+1
d1$workerid = max(d0$workerid) + d1$workerid + 1
d<-bind_rows(d,d0,d1)

e<- read.table(file='../experiments/turk/real-kinds-prior-2/real-kinds-2.results')
...
#write.csv(d.out,file='~/Documents/research/generics/models/data/real-kinds-prior-2-trials-n57-formatted.csv', row.names=F)
#write.csv(tj,file='~/Documents/research/generics/models/data/real-kinds-truth-1-trials-formatted.csv',row.names=F)
#write.csv(tj,file='~/Documents/research/generics/manuscript/data/naturalGenerics-trials-minusCatch-n96-formatted.csv',row.names=F)
