...
var listener1 = function(utterance, prior, s1optimality) {
  Enumerate(function(){
    ...
    // factor(S1_opt.score([],utterance))
    factor(s1optimality*S1.score([],utterance))
    return state
  })
}

var speaker2 = function(prevalence, prior, s1optimality){
  Enumerate(function(){
    var utterance = wordUtterancePrior()
...
// var genericListener1withTheta = function(prior, s1optimality) {
//   Enumerate(function(){

//     var state = statePrior(prior)
//     var theta = thetaPrior()
//     var S1 = speaker1(state, theta, prior)
//     factor(s1optimality*S1.score([],"generic is true"))
//     return state
