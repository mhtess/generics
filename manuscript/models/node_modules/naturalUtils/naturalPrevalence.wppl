...
var Priordata = naturalUtils.readCSV(fpath+"real-kinds-prior-2-trials-n60-formatted.csv").data
var Truthdata = naturalUtils.readCSV(fpath+"naturalGenerics-trials-formatted.csv").data
...
var prevalenceModel = function(){
	...
	foreach(properties, function(p){
		...
		foreach(categories, function(k){
			...
			query.add([k,p], avoidUpperBound(Math.round(gamma*10)/10))
