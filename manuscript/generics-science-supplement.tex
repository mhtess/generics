...
We then used a single speaker optimality parameter ($\lambda$) and a single contamination parameter ($\phi$) with the same priors as in Section \ref{sec:bdapriors4}. 
