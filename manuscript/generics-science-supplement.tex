...
To see this relation, we also plot the mean conditional prevalence compared to human judgments after hearing novel generics in Figure \ref{fig:byItemScatter} (Right). 
