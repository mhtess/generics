...
The prevalence priors inferred from Expt.~2a suggest that generic interpretation should be even more variable.
...
Further, we use the model of the speaker $S_2$ in Eq.~4 as a model of the \emph{truth conditions} task.
This is an analogous task to what was explored with generics of familiar categories in Expt.~1, also modeled by $S_2$. 
