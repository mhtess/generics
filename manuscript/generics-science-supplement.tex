...
For those responses that reflect the property is present ($d_{observed} > 0$), we assume those responses come from a distribution with unknown mean ($\gamma$) and concentration ($\phi$).
