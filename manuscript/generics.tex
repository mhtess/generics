...
If this is correct, however, there should be some criterion on the percentage of the category that must display the property (e.g. some threshold on the number of dogs that bark) for the utterance to be true.
...
They have no explicitly marked operator and yet children as young as two or three can correctly understand that they refer to unobservable categories \cite{Cimpian2008}. 
...
Language evolutionary pressures suggest that such underspecification is useful, given that there is some context through which the uncertainty can be resolved \cite{Piantadosi2012}.
In this work, context reflects a listener's beliefs about the property in question. We show how this, coupled with 
...
standard inferences from conversational pragmatics \cite{Clark1996, Grice1975, Levinson2000}, allows the listener to figure out the meaning of the otherwise vague words.
