...
Materials---novel animal names and familiar properties---were taken largely from \citeA{Cimpian2010}. 
...
Results are shown in Figure~\ref{fig:exp2a} (Left). We entered participants' truth judgments into a mixed effects logistic regression with random by-item and by-participant effects of intercept and fixed effects of prevalence and type as well as their interaction.  
...
\begin{figure}
\centering
    \includegraphics[width=\columnwidth]{asym-data-model-4opts-75k.pdf}
