...
\normalsize{Department of Psychology, Stanford University}\\
\\
\normalsize{E-mail:  mtessler@stanford.edu, ngoodman@stanford.edu}
}
...
To study this we must look to \emph{interpretation} of novel generics (e.g. \cite{Cimpian2010,Gelman2002}).
...
We compared the interpretations of the pragmatic listener in Eq.~\ref{eq:L1} to human judgments ($n=40$) about the likely prevalence of the property after hearing a generic about an unfamiliar kind (e.g. \emph{Lorches have green feathers.}). %, in the same spirit as \cite{Gelman2002}. 
