...
These simple sentences are common in child-directed speech, ordinary conversation, and political discourse.
Yet the precise meaning of generics is a puzzle that has resisted formalization.
We introduce a mathematical model of generic language by combining principles of language understanding with a basic meaning in terms of property prevalence.
...
%\begin{figure*}
%\centering
%    \includegraphics[width=1.5\columnwidth]{prevalence-scatter-wDists2.pdf}
...
%\begin{figure*}
%\centering
%    \includegraphics[width=1.7\columnwidth]{asym-lines-data-model-2phi-2so-50kx3.pdf}
...
We assume these two measurements are each distributed as a Beta diistribution:\\
\begin{minipage}{0.5 \textwidth} \small
\begin{align*}
