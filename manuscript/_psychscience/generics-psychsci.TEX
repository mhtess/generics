...
For instance, \emph{Mosquitos carry malaria} and \emph{Birds lay eggs}, but not \emph{Birds are female}.
To test the ability of the pragmatic $S_2$ model, Eq.~\ref{eq:S2}, to capture this flexibility we constructed thirty generic sentences 
...
Thus, $\theta$ is the potential of a property to be present in a kind and $\gamma$ is the mean prevalence of the property among the kinds with the potential to have it. The prevalences given by participants would then be distributed as:
...
The thirty sentences cover a range of conceptual distinctions and acceptability levels, as described above.
% and were constructed to elicit the full range of acceptability judgments (``acceptable'', ``unacceptable'', and ``uncertain'') with low-, medium-, and high-prevalence properties (as measured in Expt.~1a).
