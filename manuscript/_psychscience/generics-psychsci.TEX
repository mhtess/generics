...
We show that this model predicts the patterns in both human endorsement of familiar generic sentences and interpretation of novel generics. 
...
Language understanding in general depends on assumptions interlocutors make about each other and can result in interpreting meanings with a complex sensitivity to context \cite{Clark1996,Grice1975,Levinson2000}. 
...
We thus begin with a relatively simple semantic theory, phrased in terms of statistical regularities, measured with probability. 
...
Pragmatic reasoning is formalized in the Rational Speech Acts (RSA) theory --- a probabilisitic model of language understanding --- as recursive Bayesian inference between speaker and hearer \cite{Frank2012,Goodman2013}
...
The contrast with the \emph{null} utterance alternative gives the generic its communicative force, making it a \emph{speech-act}.
%
