...
We show that this model predicts the patterns in both human endorsement of familiar generic sentences and interpretation of novel generic sentences. 
...
d_{expected} \sim \text{Beta}(\gamma_{2}, \xi_{2})$), and construct single prevalence distributions, $P(x)$, by sampling from the posterior predictive distribution of prevalence as we did before.
...
P(x) = \beta(\gamma_{1}, \xi_{1}) \cdot \beta(\gamma_{2}, \xi_{2}) + (1 -  \beta(\gamma_{1}, \xi_{1})) \cdot \delta_{x=0} 
%
%\begin{cases} 
