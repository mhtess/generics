...
We maintain a semantics based on prevalence $P(F \mid K)$ alone because prevalence provides a way to go from generic statements to beliefs about individuals in the world. It also unifies the treatment of generic statements and quantifier sentences, a result often believed to not be possible \cite{Leslie2012default, Prasada2013, Gelman2015d}.
