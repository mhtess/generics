...
Counter-examples like \emph{Mosquitos carry malaria} and \emph{Birds lay eggs} v. \emph{Birds are female} stifles such intuition. 
Statistical theories try to rescue the notion that a generic expresses something like \emph{Ks, in general, have F}, where \emph{in general} is often either restricted to particular domain or is calculated in a distorted way.
Conceptual theories take a generic to mean \emph{Ks, in virtue of being the kind of things that Ks are, have F}.
...
The statistical and conceptual are taken to express contrasting views of the truth conditions of generic statements \cite{Carlson1995essay}.
