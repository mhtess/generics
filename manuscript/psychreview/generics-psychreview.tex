...
With a formal model, we were able to test the novel prediction that generic language is about speakers' expectations of future prevalence, and not necessarily what the current state of the world is like. 
...
It also fails to explain our data (Figure \ref{fig:commongenerics}b, right).
Our formal model, by contrast, considers not only within-kind prevalence, but a listener's prior distribution on prevalence in order to arrive at a meaning for a generic utterance.
...
Our approach thus makes the strong claim that beliefs about predicted prevalence are the connective tissue between conceptual knowledge and generic language.
