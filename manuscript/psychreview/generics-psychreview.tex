...
\subsection*{The nature of the comparison class}
...
It makes the prediction that generics should be subject to context-effects in the a way analagous to how gradable adjectives (e.g., \emph{tall}) are subject to context-effects.
...
In addition to differences in the comparison class, our theory proposes individual differences may result from disagreements in the target-kind prevalence as well as in the distribution of prevalence.
