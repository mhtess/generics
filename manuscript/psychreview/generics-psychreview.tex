...
The reason for preferring a semantics based on prevalence $P(F \mid K)$ alone is that prevalence provides a way to go from generic statements to beliefs about individuals in the world. 
