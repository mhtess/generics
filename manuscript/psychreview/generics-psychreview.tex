...
Surprisingly, we see that participants are also sensitive to the outcome of the event.
...
We do not observe substantial deviations from the predicted prevalence because there are only two different priors being used, and the shapes of those distributions do not vary appreciably (see Figure \ref{fig:prior2}).
...
Our experiment differs from the original study in a couple of ways.
The first sentence of the vignette used the possessive ``my'': ``These are my dobles.''.
At the end of the vignette, the original study had participants judge two statements in counterbalanced order: ``Do dobles have claws?'' and ``Do my dobles have claws?'' (In addition, they had participants rate their confidence on a 7-pt likert scale).
