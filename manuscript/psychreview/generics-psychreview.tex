...
\ndg{ clean up this section to read less listy and more like a description of the essential ideas from this viewpoint, and highlights of empirical support (if that's relevant).} \mht{How does this seem?}
...
\ndg{mention the pragmatic approach of mike's cogsci paper.}
...
\ndg{meh. only if we have something new to say...}
...
differences in the within-kind prevalence, the prior distributions of prevalence, or the contrast category.
