...
%We then investigate the nature of generic language more deeply.
We find that the prior beliefs used in the Bayesian model reflect conceptual structure, and this provides an understanding of the conceptual implications of generics.
...
Bare plural statements (e.g., \emph{Robins lay eggs}) tend strongly to yield a generic meaning \cite{Carlson1977}, though other forms can express such a meaning sometimes (e.g., \red{A moongoose eats snakes.} \cite{Carlson1977}). \ndg{the previous sentence is sort of out of context. cut it, move it, or work it in better...}
