...
By establishing the validity of a semantics based on prevalence alone, we provide a formalism to go from generic statements to beliefs about categories. 
Further, since prevalence is a predictive probability, the information conveyed with a generic can extend to actual entities in the world. 
